...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Fallfor.controller.ShippingInfoAction": [],
  "Fallfor.controller.UserAction": [],
  "Fallfor.model.Address": [],
  "Fallfor.model.CartProduct": [],
  "Fallfor.model.Category": [],
  "Fallfor.model.Country": [],
  "Fallfor.model.Movie": [],
  "Fallfor.model.Product": [],
  "Fallfor.model.Promotion": [],
  "Fallfor.model.User": [],
  "Fallfor.proxy.ProductProxy": [],
  "Fallfor.proxy.RottenTomatoes": [],
  "Fallfor.store.Addresses": [],
  "Fallfor.store.Cart": [],
  "Fallfor.store.Categories": [],
  "Fallfor.store.Countries": [],
  "Fallfor.store.Promotions": [],
  "Fallfor.store.Users": [],
